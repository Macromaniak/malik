...
This WordPress Donation plugin will display a form to accept donation or payment via Stripe payment gateway method.

== Description ==

[__Live Demo__](https://stripedonation.hmplugin.com/demo/) | [__Upgrade to Pro!__](https://stripedonation.hmplugin.com/pricing-faq/) | [__Live Chat__](https://stripedonation.hmplugin.com/) | [__Support__](https://stripedonation.hmplugin.com/contact/)
...
What makes this [WordPress Stripe Donation and Payment](https://stripedonation.hmplugin.com/) plugin powerful is its usability. After installation and some quick settings, donors from around the world can start donating to you via Stripe.
...
[Get the pro](https://stripedonation.hmplugin.com/pricing-faq/)
